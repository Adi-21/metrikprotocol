...
const USDC_MINT_AMOUNT = ethers.parseUnits('10000000', 6); // 10 million USDC (6 decimals)
...
async function mintTokens() {
  try {
    ...
    console.log(`   USDC Amount: ${ethers.formatUnits(USDC_MINT_AMOUNT, 6)} tokens\n`);
    ...
    try {
      ...
      console.log(`   USDC: ${ethers.formatUnits(newUsdcBalance, 6)} tokens`);
    } catch (error) {
